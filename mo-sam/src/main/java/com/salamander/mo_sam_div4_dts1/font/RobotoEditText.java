package com.salamander.mo_sam_div4_dts1.font;
...
public class RobotoEditText extends AppCompatEditText {
    ...
    private void onInitTypeface(Context context, AttributeSet attrs, int defStyle) {
        ...
        int typefaceValue = 0;
        if (attrs != null) {
            TypedArray values = context.obtainStyledAttributes(attrs, R.styleable.RobotoEditText, defStyle, 0);
            typefaceValue = values.getInt(R.styleable.RobotoEditText_fonts, 0);
            values.recycle();
        }
