...
public class EasyImage implements EasyImageConfig {
    ...
    public static final String PACKAGE_NAME = "com.salamander.mo_sam_div4_dts1";
    private static final boolean SHOW_GALLERY_IN_CHOOSER = false;
    private static final String KEY_PHOTO_URI = PACKAGE_NAME + ".photopick.photo_uri";
    private static final String KEY_LAST_CAMERA_PHOTO = PACKAGE_NAME + ".photopick.last_photo";
    private static final String KEY_TYPE = PACKAGE_NAME + ".photopick.type";
    ...
    private static Uri createCameraPictureFile(Context context) throws IOException {
        ...
        String authority = PACKAGE_NAME + ".photopick.fileprovider";
