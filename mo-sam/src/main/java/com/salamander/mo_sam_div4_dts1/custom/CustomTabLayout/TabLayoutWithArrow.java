package com.salamander.mo_sam_div4_dts1.custom.CustomTabLayout;
...
public class TabLayoutWithArrow extends HorizontalScrollView {
    ...
    private int mTabMaxWidth = 1073741823;//Integer.MAX_VALUE;
     ...
     * </p>
     *
     * @see #setTabsFromPagerAdapter(android.support.v4.view.PagerAdapter)
     * @see TabLayoutOnPageChangeListener
     * @see ViewPagerOnTabSelectedListener
     */
    public void setupWithViewPager(@NonNull ViewPager viewPager) {
        final android.support.v4.view.PagerAdapter adapter = viewPager.getAdapter();
        if (adapter == null) {
    ...
    /**
     * Populate our tab content from the given {@link android.support.v4.view.PagerAdapter}.
     * <p>
     * Any existing tabs will be removed first. Each tab will have it's text set to the value
     * returned from {@link android.support.v4.view.PagerAdapter#getPageTitle(int)}
     * </p>
     *
     * @param adapter the adapter to populate from
     */
    public void setTabsFromPagerAdapter(@NonNull android.support.v4.view.PagerAdapter adapter) {
        removeAllTabs();
    ...
    class TabView extends LinearLayout implements OnLongClickListener {
        ...
        public TabView(Context context, Tab tab) {
            ...
            if (mTabBackgroundResId != 0) {
                setBackground(AppCompatDrawableManager.get().getDrawable(context, mTabBackgroundResId));
            }
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        public void draw(Canvas canvas) {
            ...
            if (mIndicatorLeft >= 0 && mIndicatorRight > mIndicatorLeft) {
                canvas.drawRect(mIndicatorLeft, getHeight() - 1 - mSelectedIndicatorHeight, mIndicatorRight, getHeight() - 1, mSelectedIndicatorPaint);
        ...
        private Path getTrianglePath(int arrowSize) {
            ...
            int leftPointX = mIndicatorLeft + (mIndicatorRight - mIndicatorLeft) / 2 - arrowSize;
            int rightPointX = leftPointX + arrowSize * 2;
            int bottomPointX = leftPointX + arrowSize;

            int bottomPointY = getHeight() - 1 - arrowSize - mSelectedIndicatorHeight;
            int leftPointY = getHeight() - 1 - mSelectedIndicatorHeight;
