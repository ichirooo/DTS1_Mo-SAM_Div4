...
public class CircularImageView extends AppCompatImageView {
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        // Disable this view's hardware acceleration on Honeycomb and up (Needed
        // for shadow effect)
    ...
    /**
     * Enables a dark shadow for this CircularImageView. If the radius is set to
     * 0, the shadow is removed.
     *
     * @param radius
     * @param dx
     * @param dy
