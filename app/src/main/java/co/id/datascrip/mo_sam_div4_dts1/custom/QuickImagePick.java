...
import co.id.datascrip.mo_sam_div4_dts1.Utils;
...
public class QuickImagePick {
    ...
    private static File createImageFile(@NonNull final Context pContext) {
        ...
        final String fileName = Global.getBEX(pContext).getInitial() + "_" + String.valueOf(ID_KEGIATAN) + "_" + String.valueOf(NO) + ".jpg";
    ...
    private static void handleResultFromGallery(@NonNull final Context pContext, final int pRequestType, @NonNull final Callback pCallback,
        ...
        current_file = new File(Utils.getRealPathFromURI(pContext, pictureUri));
        if (pictureUri == null) {
