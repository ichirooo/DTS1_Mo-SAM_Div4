...
public class LocationLibraryConstants {
    ...
    public static final String LOCATION_BROADCAST_EXTRA_LOCATIONINFO = "co.id.datascrip.mo_sam_div4_dts1.littlefluffy.LocationInfo";
    protected static final String TAG = "MoSAM_DTS1";
    protected static final String LOCATION_CHANGED_PERIODIC_BROADCAST_ACTION = ".littlefluffy.LOCATION_CHANGED";
    protected static final String LOCATION_CHANGED_TICKER_BROADCAST_ACTION = ".littlefluffy.LOCATION_CHANGED_TICK";
