/*
com.example.cekgaransi.fonts.GoTextView * Copyright (C) 2014 Marco Hernaiz Cao
 *
 ...
 */
package com.datascrip.salamander_calendar.fonts;
...
import com.datascrip.salamander_calendar.R;

/**
 * Implementation of a {@link GoTextView} with native support for all the Roboto
 * fonts.
 *
...
public class GoTextView extends AppCompatTextView {
     ...
     * @see #GoTextView(Context, AttributeSet, int)
     */
     ...
     * @see #GoTextView(Context, AttributeSet)
     */
    public GoTextView(Context context, AttributeSet attrs, int defStyle) {
